...
class Simulation:
    ...
    def __init__(self, model):
        ...
        Traffic_gen = Traffic.TrafficGenerator()
        self.gamma = 0.75
        self.step_count = 0
    ...
    def run(self, episode, epsilon):
        ...
        print("Toatal reward:", reward, "-Epsilon: ", round(epsilon, 2))
        traci.close()
        simulation_time = round(datetime.datetime.now() - start_time, 1)
        ...
        training_time = round(datetime.datetime.now() - train_start_time, 1)
    ...
    def replay(self):
        ...
        """
        batch = self.Memory.get_sample(self.Model.batch_size)
